...
import { MediaCoverageTab } from './components/MediaCoverageTab';
...
export default function App() {
  ...
  const tabs = [
    ...
    { id: 'media', name: 'Media Coverage', icon: TrendingUp },
    { id: 'live', name: 'Live Monitoring', icon: Radio },
    { id: 'trends', name: 'Trends & Analytics', icon: BarChart3 },
    { id: 'response', name: 'Response Management', icon: MessageCircle }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <p className="text-sm text-gray-600">
              Powered by Kaiku Intelligence Platform • Data from Meltwater
            </p>
            <p className="text-sm text-gray-600">
